 ...
 * @author Damien
 */
public class DialogFormCv extends javax.swing.JDialog {
    ...
    public DialogFormCv(com.karimandco.print.Affichage fen) {
        this.objAutreFenetre = fen;
        initComponents();
        creationDuCV1.setPanneauPereAffichage(fen);
    }

    public CreationDuCV getPanneauCv() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogFormCv.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
