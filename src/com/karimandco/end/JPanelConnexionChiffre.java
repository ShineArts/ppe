 ...
 * @author f.bruckmann
 */
public class JPanelConnexionChiffre extends javax.swing.JPanel {
...
//    }
    ...
    private void initComponents() {
        ...
        jButtonAnnuler.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        jButtonAnnuler.setForeground(new java.awt.Color(255, 255, 255));
        jButtonAnnuler.setText("Vider mot de passe");
        ...
        jButtonCorriger.setBackground(new java.awt.Color(255, 102, 0));
        jButtonCorriger.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
        jButtonCorriger.setForeground(new java.awt.Color(255, 255, 255));
        jButtonCorriger.setText("Supprimer");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(53, 53, 53)
                        .addComponent(jLabelErreur, javax.swing.GroupLayout.PREFERRED_SIZE, 480, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(45, 45, 45)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(jButtonAnnuler, javax.swing.GroupLayout.DEFAULT_SIZE, 243, Short.MAX_VALUE)
                                    .addComponent(jLabelEtatConnexion, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))))
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(jLabelEtatConnexion, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(layout.createSequentialGroup()
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(jButton10, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jButton9, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(jButton20, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE))))))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jButtonCorriger, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    private void jButtonConfirmerConnexionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConfirmerConnexionActionPerformed
        if (panneauIdentifiant.getChamp2().verifIdentifiant() && panneauMdp.getChampSecret1().verifPassword()) {
            ...
            try {
                ...
                Logger.getLogger(JPanelConnexionChiffre.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
            jLabelErreur.setForeground(Color.black);
    ...
    private void jButtonCorrigerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCorrigerActionPerformed
        if (String.valueOf(panneauMdp.getChampSecret1().getPassword()).length() <= 0) {
            jLabelErreur.setText("Vous ne pouvez pas supprimer des caractéres car le champ est vide");
    ...
    public void updateJLabelEtatChamp() {
        if (!panneauIdentifiant.getChamp2().getText().equals("")) {
            ...
            panneauIdentifiant.setjLabelEtatChamp(Color.red);
            panneauIdentifiant.setjLabelEtatChamp("Veuillez completer ce champ");
    ...
    public void updateJLabelEtatChampSecret() {
        if (!String.valueOf(panneauMdp.getChampSecret1().getPassword()).equals("")) {
            ...
            panneauMdp.setjLabelEtatChampSecret(Color.red);
            panneauMdp.setjLabelEtatChampSecret("Veuillez completer ce champ");
